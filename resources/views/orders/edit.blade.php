...
<body>
    <form action="{{ route('orders.update', $order->order_id) }}" method="POST">
        ...
        <div>
            ...
            <input type="datetime-local" name="order_date" value="{{ $order->order_date }}">
            @error('order_date')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="number" name="room_no" value="{{ $order->room_no }}">
            @error('room_no')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="number" name="admin_id" value="{{ $order->admin_id }}">
            @error('admin_id')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
